...
const HowCard = ({title , body,imgSrc}) => {
  ...
  return (
    <Card className="bg-black  overflow-hidden  border-white/25  md:w-[350px] max-w-[400px] h-[500px] md:h-[550px] rounded-sm shadow-[inset_0px_-66px_64px_-48px_#432C81,inset_0px_-68px_64px_-32px_#826CFF,inset_20px_-20px_50px_-10px_rgba(0,0,0,0.5)] mix-blend-lighten" dir={isArabic ? "rtl" : "ltr"}>

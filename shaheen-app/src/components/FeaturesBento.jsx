export default function Home() {
  return (
    <div className="min-h-screen flex flex-col gap-20 mt-25 md:mt-51  p-4 md:p-8">
      ...
      <div className="md:col-span-1 lg:col-span-1 md:row-span-2 lg:row-span-2 bg-black border border-gray-400 shadow-[inset_0px_-246px_64px_-48px_#a43dee85,inset_0px_-308px_64px_-32px_#7c67f3,inset_20px_-20px_50px_-10px_rgba(0,0,0,0.5)] mix-blend-lighten rounded-2xl relative overflow-hidden flex flex-col justify-between p-8 min-h-[400px] md:min-h-[500px] ">
        ...
        {/* Card 2 */}
        <div className="md:col-span-1 lg:col-span-1 md:row-span-1 lg:row-span-1  bg-black border border-gray-400 shadow-[inset_0px_-126px_64px_-48px_#a43dee85,inset_0px_-126px_64px_-32px_#7c67f3,inset_20px_-20px_50px_-10px_rgba(0,0,0,0.5)] mix-blend-lighten rounded-2xl relative overflow-hidden flex flex-col  p-6 min-h-[200px]">

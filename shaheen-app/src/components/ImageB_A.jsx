...
const ImageB_A = () => {
  ...
  return (
    <div className="w-full px-4 flex mt-10  h-screen flex-col gap-15 justify-center items-center  lg:px-20 ">
      {/* HEADING */}
      ...
      <div className=" h-[500px] md:w-[70%]w-[50%] relative">
        <img
        ...
        <div className="absolute top-6 left-6  border  overflow-hidden md:w-[250px] md:h-[250px] w-[150px] h-[150px] py-6 flex flex-col bg-white justify-center items-center">
          <p className="text-black text-base font-bold pt-6">{t("before")}</p>
          <img
